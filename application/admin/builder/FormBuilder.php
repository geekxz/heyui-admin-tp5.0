...
class FormBuilder extends Builder{
	...
	/**
     * 设置Tab按钮列表
     * @param $tab_list    Tab列表  array('title' => '标题', 'href' => 'http://www.jianong.com')
    ...
    public function display() {
        ...
        $view->assign('post_url',    $this->_post_url);    //标题提交地址
        $view->assign('form_items',  $this->_form_items);  //表单项目
        $view->assign('ajax_submit', $this->_ajax_submit); //额外HTML代码
        $view->assign('extra_html',  $this->_extra_html);  //是否ajax提交
		return  $view->fetch('admin@builder/form',[],config('view_replace_str'));
    }
}